...
| 컨셉 | 화면 | 세는 것 | 활동 |
|---|---|---|---|
| 낚시 | 바다와 낚싯배 | 물고기 | 입질 · 캐스팅 |
| 마을 | 들판과 집 | 주민 | 북적임 · 방문 |
| 목장 | 초원과 헛간 | 동물 | 울음소리 · 먹이 주기 |
| 우주 | 성간과 로켓 | 별 | 전파 · 교신 |
| 정원 | 화단과 온실 | 꽃 | 개화 · 물주기 |
| 광산 | 갱도와 수갱 | 광석 | 곡괭이질 · 채굴 |
| 도시 | 도로와 빌딩 | 차 | 교통량 · 운행 |
...
| 제목 | 의미 |
|---|---|
| `token fishing 0.7.0 · 공식·훅` | 상태줄 훅에서 받은 실시간 공식 값 |
| `token fishing 0.7.0 · 공식·앱` | 데스크톱 앱 기록의 공식 값 (최대 15분 지연) |
| `token fishing 0.7.0 · 어림(공식수치 없음)` | 공식 값을 받지 못해 자체 추정치로 표시 중 |
